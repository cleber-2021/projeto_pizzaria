...
<html lang="pt-br">
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<!-- EDIÇÃO de um registro específico: -->
	 ...
	 <div class="container">
          ...
          <form  method="post" <?php if($altera) { echo 'action="altera.php"';} else { echo 'action="insere.php"'; } ?> autocomplete>
          <div class="form-row">
 ...
 <table class="table table-dark"><!-- Tabela com registros inseridos -->
    ...
    <tr>
      ...
      <td>
      <?php echo '<form method="post" action="cadastro.php">';
                  echo '<input type="hidden" name="codigo" value="'.$registro['id_sabor'].'"/>';    
                  echo '<input type="submit"  value="Editar" name="edit"/>';
                  echo '</form>'; ?>
            </td>
         <td>
			<?php echo '<form method="post" action="exclui.php">';
                  echo '<input type="hidden" name="codigo" value="'.$registro['id_sabor'].'"/>';    
                  echo '<input type="submit" value="Excluir" name="del"/>';
                  echo '</form>'; ?>
            </td>
    </tr>
    <?php } ?> 
