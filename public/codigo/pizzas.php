...
<html lang="pt-br">
    ...
    <body>
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href=".././codigo/pizzas.php" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Pizzas
                </a>
              </li>
               <li class="nav-item">
    ...
    <div class="container">
        <h1>
            <p class="info"><strong>Escolha o sabor:</strong></p>
        </h1>
        <table>
          <tr>
            <td><a href="./doce.php"><img src=".././imagens/pizza/doce.jpg" class="img-thumbnail" width="325px" height="200px">
                </a><p>Doce</p>
            </td>
            <td><a href="./salgada.php"><img src=".././imagens/pizza/salgada.jpg" class="img-thumbnail" width="325px" height="200px">
                </a><p>Salgada</p>
            </td>
          </tr>
        </table>
